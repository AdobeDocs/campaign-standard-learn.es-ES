...
+ Introducción {#getting-started}
   ...
   + [Explicación de perfiles y públicos](/help/getting-started/understanding-profiles-and-audiences.md)
...
+ Perfiles y públicos {#profiles-and-audiences}
   + [Creación de perfiles y públicos: información general](/help/profiles-and-audiences/creating-profiles-and-audiences.md)
...
+ Canales de comunicación {#communication-channels}
   + Correo electrónico {#email}
      ...
      + Correos electrónicos con IA {#journey-ai}
   ...
   + Páginas de destino {#landing-pages}
      + [Creación y edición de una página de destino](/help/communication-channels/landing-pages/landing-page-create-and-edit.md)
      + [Prueba y publicación de una página de destino](/help/communication-channels/landing-pages/landing-page-test-and-publish.md)
      + [Configuración de la plantilla de una página de destino](/help/communication-channels/landing-pages/landing-page-configure-templates.md)
+ Diseño y personalización del contenido {#designing-content}
   + Diseñador de correos electrónicos{#email-designer}
...
+ Privacidad {#privacy}
   ...
   + [Creación de espacios de nombres para solicitudes de privacidad](/help/privacy/namespaces-for-privacy-requests.md)
